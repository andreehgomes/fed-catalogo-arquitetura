...
@Component({
  ...
  templateUrl: "./blog-page-mix-grid-left-sidebar.html",
  styleUrls: ["./blog-page-mix-grid-left-sidebar.scss"],
  imports: [Breadcrumb, BlogPageFilter, BlogPageBlogdata, CommonModule],
})
export class BlogPageMixGridLeftSidebar {
