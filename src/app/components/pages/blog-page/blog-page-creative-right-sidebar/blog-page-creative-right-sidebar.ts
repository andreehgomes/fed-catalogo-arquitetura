...
@Component({
  ...
  templateUrl: "./blog-page-creative-right-sidebar.html",
  styleUrls: ["./blog-page-creative-right-sidebar.scss"],
  imports: [Breadcrumb, BlogPageBlogdata, BlogPageFilter],
})
export class BlogPageCreativeRightSidebar {
