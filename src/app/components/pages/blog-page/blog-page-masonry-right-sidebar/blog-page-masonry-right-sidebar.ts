...
@Component({
  ...
  templateUrl: "./blog-page-masonry-right-sidebar.html",
  styleUrls: ["./blog-page-masonry-right-sidebar.scss"],
  imports: [Breadcrumb, BlogPageFilter, BlogPageBlogdata, NgxMasonryModule],
})
export class BlogPageMasonryRightSidebar {
