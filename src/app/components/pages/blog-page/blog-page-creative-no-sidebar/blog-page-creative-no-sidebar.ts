...
@Component({
  ...
  templateUrl: "./blog-page-creative-no-sidebar.html",
  styleUrls: ["./blog-page-creative-no-sidebar.scss"],
  imports: [Breadcrumb, BlogPageBlogdata],
})
export class BlogPageCreativeNoSidebar {
