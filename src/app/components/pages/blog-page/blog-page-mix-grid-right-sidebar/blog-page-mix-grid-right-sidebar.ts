...
@Component({
  ...
  templateUrl: "./blog-page-mix-grid-right-sidebar.html",
  styleUrls: ["./blog-page-mix-grid-right-sidebar.scss"],
  imports: [Breadcrumb, BlogPageBlogdata, BlogPageFilter, CommonModule],
})
export class BlogPageMixGridRightSidebar {
