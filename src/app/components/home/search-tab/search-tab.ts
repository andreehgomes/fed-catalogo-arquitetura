...
import { SearchTabHomeSection } from "./search-tab-home-section/search-tab-home-section";
...
import { SliderFilterLatestSale } from "../slider-filter-search/slider-filter-latest-sale/slider-filter-latest-sale";
