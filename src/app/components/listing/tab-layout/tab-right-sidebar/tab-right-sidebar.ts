...
@Component({
  ...
  templateUrl: "./tab-right-sidebar.html",
  styleUrls: ["./tab-right-sidebar.scss"],
  imports: [Breadcrumb, CommonTabPropertyBox, CommonFilterListing],
})
export class TabRightSidebar {
