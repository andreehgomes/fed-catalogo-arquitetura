...
@Component({
  ...
  templateUrl: "./property-thumbnail-images.html",
  styleUrls: ["./property-thumbnail-images.scss"],
  imports: [Gallery, Property, RelatedProperty, AdvanceFilter, HomeDetails],
})
export class PropertyThumbnailImages {
