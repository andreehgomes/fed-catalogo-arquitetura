import {
  AvailablePropertyDataChart,
  FullChartDetails,
  SalesByAgentChart,
  SalesOverviewChart,
} from "../interface/chart";

export const totalAgents: FullChartDetails = {
  type: "Bar",
  data: {
...
export const totalSales: FullChartDetails = {
  type: "Bar",
  data: {
    labels: ["Q1", "Q2", "Q3", "Q4", "Q5", "Q6", "Q7"],
    series: [
...
export const totalProperty: FullChartDetails = {
  type: "Bar",
  data: {
    labels: ["Q1", "Q2", "Q3", "Q4", "Q5", "Q6", "Q7"],
    series: [
...
export const salesOverviewChart: SalesOverviewChart = {
  series: [
    {
      name: "$2530.00",
...
export const salesByAgent: SalesByAgentChart = {
  chart: {
    height: 375,
    type: "bar",
    toolbar: {
...
export const availablePropertyData: AvailablePropertyDataChart = {
  chart: {
    height: 330,
    type: "radialBar",
  },
